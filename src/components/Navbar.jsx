    ...
    <nav className="bg-indigo-600 shadow-lg sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex justify-between">
          ...
          {/* Secondary Nav */}
          <div className="hidden md:flex items-center space-x-1">
            <a href="/login" className="py-2 px-3 bg-gray-700 hover:bg-gray-600 text-white rounded-md transition duration-300">Login</a>
      ...
      <div className={`${isOpen ? 'block' : 'hidden'} md:hidden`}>
        <a href="/" className="block py-2 px-4 text-sm hover:bg-gray-700 text-white">Home</a>
        ...
        <a href="/about" className="block py-2 px-4 text-sm hover:bg-gray-700 text-white">About</a>
        <div className="py-2">
          <a href="/login" className="block py-2 px-4 text-sm hover:bg-gray-700 text-white">Login</a>
